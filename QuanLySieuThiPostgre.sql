...
INSERT INTO khuyenmai (makm, tenchuongtrinh, mota, loaikm, giatrikm, couponcode, dieukienapdung, ngaybatdau, ngayketthuc, soluongtoida, dasudung, maquanly, trangthai) VALUES
                                                                                                                                                                           ...
                                                                                                                                                                           ('KMSP004', 'Giảm giá tháng 8', 'Giảm giá đặc biệt cho tháng 8', 'PhanTram', 15.0, 'AUGUST-15', 'Áp dụng cho tất cả sản phẩm, giảm 15%', '2025-08-01 00:00:00', '2025-08-31 23:59:59', 1500, 0, 'NV002', 1),
                                                                                                                                                                           ('KMSP005', 'Giảm giá sinh nhật', 'Giảm giá đặc biệt cho khách hàng trong tháng sinh nhật', 'PhanTram', 20.0, 'BIRTHDAY-20', 'Áp dụng cho khách hàng có sinh nhật trong tháng, giảm 20%', '2025-01-01 00:00:00', '2025-12-31 23:59:59', 3000, 150, 'NV002', 1),
                                                                                                                                                                           ('KMSP006', 'Khuyến mãi cuối tuần', 'Giảm giá cho các sản phẩm tiêu dùng vào cuối tuần', 'PhanTram', 12.0, 'WEEKEND-12', 'Áp dụng cho sản phẩm tiêu dùng vào thứ 6, 7, chủ nhật, giảm 12%', '2025-01-01 00:00:00', '2025-12-31 23:59:59', 5000, 800, 'NV002', 1),
                                                                                                                                                                           ('KMSP007', 'Giảm giá sản phẩm mới', 'Giảm giá cho các sản phẩm mới nhập kho', 'PhanTram', 18.0, 'NEW-18', 'Áp dụng cho sản phẩm mới nhập trong vòng 30 ngày, giảm 18%', '2025-01-01 00:00:00', '2025-12-31 23:59:59', 2000, 300, 'NV002', 1),
                                                                                                                                                                           ('KMSP008', 'Khuyến mãi theo điểm tích lũy', 'Giảm giá dựa trên điểm tích lũy của khách hàng', 'PhanTram', 25.0, 'POINTS-25', 'Khách hàng có từ 1000 điểm trở lên được giảm 25%', '2025-01-01 00:00:00', '2025-12-31 23:59:59', 1500, 200, 'NV002', 1);
